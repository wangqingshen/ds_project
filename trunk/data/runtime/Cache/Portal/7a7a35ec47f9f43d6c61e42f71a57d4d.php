...
<head>
<meta charset="utf-8">
<title><?php echo ($site_name); ?> 联系我们</title>
<meta name="keywords" content="<?php echo ($site_seo_keywords); ?>" />
<meta name="description" content="<?php echo ($site_seo_description); ?>">
<link rel="stylesheet" href="/deshang/trunk/themes/simplebootx/Public/css/animate.css" />
<link rel="stylesheet" href="/deshang/trunk/themes/simplebootx/Public/css/animate-tool.css" />
			...
			<div class="contact-fun">
				<div class="contact-item">
					...
					<div class="flip in flip-before">
						<em class="contact-item-img" style="background: url(/deshang/trunk/themes/simplebootx/Public/images/icon/contact_email.png) no-repeat center"></em>
				...
				<div class="contact-item" style="margin-right: 0;">
					...
					<em class="contact-item-img" style="background: url(/deshang/trunk/themes/simplebootx/Public/images/icon/contact_add.png) no-repeat center"></em>

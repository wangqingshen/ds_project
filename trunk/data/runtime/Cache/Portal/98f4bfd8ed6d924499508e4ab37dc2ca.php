...
<body>
							...
							<td>
								<div style="text-align: center;">
									...
									<a href="javascript:void(0);" onclick="flashupload('thumb_images', '附件上传','thumb',thumb_images,'1,jpg|jpeg|gif|png|bmp,1,,,1','','','');return false;">
										<?php if(empty($smeta['thumb'])): ?><img src="/deshang/trunk/admin/themes/simplebootx/Public/assets/images/default-thumbnail.png" id="thumb_preview" width="135" style="cursor: hand"/>
										<?php else: ?>
	...
	<script type="text/javascript" src="/deshang/trunk/public/js/ueditor/ueditor.config.js"></script>
	<script type="text/javascript" src="/deshang/trunk/public/js/ueditor/ueditor.all.min.js"></script>
	<script type="text/javascript">
		$(function() {
